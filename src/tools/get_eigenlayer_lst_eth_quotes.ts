...
const EN_BASE = "Finalized stETH/rETH/cbETH/ETHx/osETH/lsETH/mETH quotes: 7/12; share/custody distinct partials.";
const EN_LIMITATION = "No full LST/native/EigenLayer total, net ETH, protocol demand, rehypothecation, backing, or executable exit capacity; unverified: cbETH rate freshness, ETHx oracle-report freshness or proxy implementation/source correspondence, osETH virtual-reward-input freshness, lsETH oracle-report freshness or proxy implementation/source correspondence, mETH oracle-record freshness.";
const EN_UNAVAILABLE = "No quotes observed for stETH/rETH/cbETH/ETHx/osETH/lsETH/mETH (7/12); share/custody distinct partials.";
