...
const EN_BASE = "Finalized stETH/rETH/cbETH/ETHx/osETH/lsETH/mETH accounting quotes cover 7 of 12; share/custody distinct partials.";
const EN_LIMITATION = "No full LST/native/EigenLayer total, net ETH, protocol demand, rehypothecation, backing, or executable exit capacity; unverified: cbETH rate, ETHx oracle-report freshness or proxy implementation/source correspondence, osETH reward freshness, lsETH oracle-report freshness or proxy implementation/source correspondence, mETH record freshness.";
const EN_UNAVAILABLE = "Direct accounting view for 7 of 12 (stETH/rETH/cbETH/ETHx/osETH/lsETH/mETH): unavailable; no quotes were observed; share/custody distinct partials.";
