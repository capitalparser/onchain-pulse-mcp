...
const TOOLS: ToolDef[] = [
  ...
  },
  {
    ...
    description: "Finalized direct protocol-accounting quotes for stETH/rETH/cbETH/ETHx/osETH/lsETH/mETH covering only 7 of 12 fixed EigenLayer strategies; broader totals stay null.",
    inputSchema: { type: "object", properties: {}, additionalProperties: false },
